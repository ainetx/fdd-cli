# Feature Validation - Feature Design
...
Implement `fdd validate feature` command with Feature Design document validation and 100/100 + 100% completeness requirement.
